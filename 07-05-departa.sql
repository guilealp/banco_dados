...
-- exercicio 2
delimiter //
create procedure inserir_funcionario(x_nome varchar(50), x_email varchar(255), x_senha varchar(255), x_id_departamento int, x_valor_hora decimal)
begin
...
call inserir_funcionario ('henrique','henrique@gmail.com','123456',6,50.00);
