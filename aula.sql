...
from disciplinas d 
left join professores p on d.id_disciplina  = p.id_professor 
...
where d.nome = 'Matematica Avançada';
...
-- exercicio 16
select max(n.nota)as maior_notas
from notas n 
inner join disciplinas d on d.id_disciplina =n.id_disciplina 
...
-- exercicio 19
select d.nome as id_disciplina , count(m.id_aluno) as total_alunos 
from disciplinas d 
...
select avg(nota) as maior_nota from notas n ;
